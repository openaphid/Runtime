...
namespace AJ {
    ...
    class Arguments : public AJObject {
    public:
    ...
    private:
        ...
        virtual void put(ExecState*, unsigned propertyName, AJValue, PutPropertySlot&);
    ...
    Arguments* asArguments(AJValue);

    inline Arguments* asArguments(AJValue value)
    {
        ASSERT(asObject(value)->inherits(&Arguments::info));
        return static_cast<Arguments*>(asObject(value));
    }

    ALWAYS_INLINE void Arguments::getArgumentsData(CallFrame* callFrame, AJFunction*& function, ptrdiff_t& firstParameterIndex, Register*& argv, int& argc)
    {
    ...
    inline Arguments::Arguments(CallFrame* callFrame)
        : AJObject(callFrame->lexicalGlobalObject()->argumentsStructure())
        , d(new ArgumentsData)
    {
        AJFunction* callee;
        ptrdiff_t firstParameterIndex;
