...
namespace AJ {
    ...
    public:
        ScopeChainNode(ScopeChainNode* next, AJObject* object, AJGlobalData* globalData, AJGlobalObject* globalObject, AJObject* globalThis)
            : next(next)
            , object(object)
    ...
    inline ScopeChainNode* ScopeChainNode::push(AJObject* o)
    {
        ASSERT(o);
    ...
    public:
        ...
        AJObject* const & operator*() const { return m_node->object; }
        AJObject* const * operator->() const { return &(operator*()); }
    ...
    public:
        ...
        ScopeChain(AJObject* o, AJGlobalData* globalData, AJGlobalObject* globalObject, AJObject* globalThis)
