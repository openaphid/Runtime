...
public:
    ...
    AtomicString(ATF::HashTableDeletedValueType) : m_string(ATF::HashTableDeletedValue) { }
...
namespace ATF {
    ...
    template<> struct DefaultHash<Aphid::AtomicString> {
        typedef Aphid::AtomicStringHash Hash;
    };
