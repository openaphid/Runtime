...
public:
    ...
    String(ATF::HashTableDeletedValueType) : m_impl(ATF::HashTableDeletedValue) { }
    ...
    ATF::Unicode::Direction defaultWritingDirection() const { return m_impl ? m_impl->defaultWritingDirection() : ATF::Unicode::LeftToRight; }
...
namespace ATF {
    ...
    template<> struct DefaultHash<Aphid::String> {
