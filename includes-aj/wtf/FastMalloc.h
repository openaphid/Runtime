...
using ATF::fastCalloc;
using ATF::fastFree;
using ATF::fastMalloc;
using ATF::fastMallocSize;
using ATF::fastRealloc;
using ATF::fastStrDup;
using ATF::fastZeroedMalloc;
using ATF::tryFastCalloc;
using ATF::tryFastMalloc;
using ATF::tryFastRealloc;
using ATF::tryFastZeroedMalloc;

#ifndef NDEBUG    
using ATF::fastMallocForbid;
using ATF::fastMallocAllow;
#endif
