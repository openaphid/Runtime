...
namespace AJ  {
    ...
    public:
        AJFunction* callee() const { return this[RegisterFile::Callee].function(); }
        ...
        AJGlobalObject* lexicalGlobalObject() const
        {
        ...
        void setException(AJValue exception) { globalData().exception = exception; }
        void clearException() { globalData().exception = AJValue(); }
        AJValue exception() const { return globalData().exception; }
        AJValue* exceptionSlot() { return &globalData().exception; }
        ...
        void setCalleeArguments(AJValue arguments) { static_cast<Register*>(this)[RegisterFile::OptionalCalleeArguments] = arguments; }
        ...
        ALWAYS_INLINE void init(CodeBlock* codeBlock, Instruction* vPC, ScopeChainNode* scopeChain,
            CallFrame* callerFrame, int returnValueRegister, int argc, AJFunction* function)
        {
    ...
    private:
        ...
        void setCallee(AJFunction* callee) { static_cast<Register*>(this)[RegisterFile::Callee] = callee; }
