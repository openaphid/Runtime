...
#ifndef OpenAphid_AJDirector_h
#define OpenAphid_AJDirector_h
...
namespace Aphid {
	...
	///-------------------------------------------------------------------------------------------------------------------
	class AJDirector : public AJOAObject {
		typedef AJOAObject Base;

	public:
		AJDirector(NonNullPassRefPtr<AJ::Structure> structure, AJOAGlobalObject* globalObject, PassRefPtr<Director> impl);
		virtual ~AJDirector();
		...
		Director* impl() const {return m_impl.get();}
	...
	///-------------------------------------------------------------------------------------------------------------------
	class AJDirectorPrototype : public AJ::AJObject {
		typedef AJ::AJObject Base;

	public:
		AJDirectorPrototype(NonNullPassRefPtr<AJ::Structure> structure);
		...
		{
			return AJ::asObject(getOAStructure(AJDirectorBindingType, exec, globalObject)->storedPrototype());
		}
	...
	///-------------------------------------------------------------------------------------------------------------------
	Director* toDirector(AJ::AJValue value);
	AJ::AJValue toAJ(AJ::ExecState* exec, AJOAGlobalObject* globalObject, Director* impl);

#include "AJDirector_properties.in.h"
} //namespace Aphid
