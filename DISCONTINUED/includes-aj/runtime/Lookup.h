...
namespace AJ {
    ...
    struct HashTableValue {
        ...
        unsigned char attributes; // AJObject attributes
        intptr_t value1;
        intptr_t value2;
#if ENABLE(JIT)
    ...
    // ie. typedef AJValue (*GetFunction)(ExecState*, AJObject* baseObject)
    typedef PropertySlot::GetValueFunc GetFunction;
    typedef void (*PutFunction)(ExecState*, AJObject* baseObject, AJValue value);
    ...
    private:
        UString::Rep* m_key;
        unsigned char m_attributes; // AJObject attributes
    ...
    struct HashTable {
        ...
        ALWAYS_INLINE void initializeIfNeeded(AJGlobalData* globalData) const
        {
            if (!table)
        ...
        ALWAYS_INLINE const HashEntry* entry(AJGlobalData* globalData, const Identifier& identifier) const
        {
    ...
    private:
        ...
        void createTable(AJGlobalData*) const;
    };

    void setUpStaticFunctionSlot(ExecState*, const HashEntry*, AJObject* thisObject, const Identifier& propertyName, PropertySlot&);
    ...
    inline bool getStaticFunctionSlot(ExecState* exec, const HashTable* table, AJObject* thisObj, const Identifier& propertyName, PropertySlot& slot)
    {
     ...
     */
    template <class ParentImp>
    inline bool getStaticFunctionDescriptor(ExecState* exec, const HashTable* table, AJObject* thisObj, const Identifier& propertyName, PropertyDescriptor& descriptor)
    {
    ...
    inline bool lookupPut(ExecState* exec, const Identifier& propertyName, AJValue value, const HashTable* table, ThisImp* thisObj)
    {
        const HashEntry* entry = table->entry(exec, propertyName);
     ...
     */
    template <class ThisImp, class ParentImp>
    inline void lookupPut(ExecState* exec, const Identifier& propertyName, AJValue value, const HashTable* table, ThisImp* thisObj, PutPropertySlot& slot)
    {
