...
namespace AJ {
    ...
    using ATF::PlacementNewAdoptType;
    using ATF::PlacementNewAdopt;
    ...
    struct IdentifierRepHash : PtrHash<RefPtr<AJ::UString::Rep> > {
        static unsigned hash(const RefPtr<AJ::UString::Rep>& key) { return key->existingHash(); }
        static unsigned hash(AJ::UString::Rep* key) { return key->existingHash(); }
    };
...
namespace ATF {
    ...
    template<> struct StrHash<AJ::UString::Rep*> {
        static unsigned hash(const AJ::UString::Rep* key) { return key->hash(); }
        static bool equal(const AJ::UString::Rep* a, const AJ::UString::Rep* b) { return ::equal(a, b); }
        static const bool safeToCompareToEmptyOrDeleted = false;
    };

    template<> struct StrHash<RefPtr<AJ::UString::Rep> > : public StrHash<AJ::UString::Rep*> {
        using StrHash<AJ::UString::Rep*>::hash;
        static unsigned hash(const RefPtr<AJ::UString::Rep>& key) { return key->hash(); }
        using StrHash<AJ::UString::Rep*>::equal;
        static bool equal(const RefPtr<AJ::UString::Rep>& a, const RefPtr<AJ::UString::Rep>& b) { return ::equal(a.get(), b.get()); }
        static bool equal(const AJ::UString::Rep* a, const RefPtr<AJ::UString::Rep>& b) { return ::equal(a, b.get()); }
        static bool equal(const RefPtr<AJ::UString::Rep>& a, const AJ::UString::Rep* b) { return ::equal(a.get(), b); }

        static const bool safeToCompareToEmptyOrDeleted = false;
    };

    template <> struct VectorTraits<AJ::UString> : SimpleClassVectorTraits
    {
