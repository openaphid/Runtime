...
#ifndef OpenAphid_AJNamespaceCore_h
#define OpenAphid_AJNamespaceCore_h
...
namespace Aphid {
	...
	///-------------------------------------------------------------------------------------------------------------------
	class AJNamespaceCore : public AJOAObject {
		typedef AJOAObject Base;

	public:
		AJNamespaceCore(NonNullPassRefPtr<AJ::Structure> structure, AJOAGlobalObject* globalObject, PassRefPtr<NamespaceCore> impl);
		virtual ~AJNamespaceCore();
		...
		NamespaceCore* impl() const {return m_impl.get();}
	...
	///-------------------------------------------------------------------------------------------------------------------
	class AJNamespaceCorePrototype : public AJ::AJObject {
		typedef AJ::AJObject Base;

	public:
		AJNamespaceCorePrototype(NonNullPassRefPtr<AJ::Structure> structure);
		...
		{
			return AJ::asObject(getOAStructure(AJNamespaceCoreBindingType, exec, globalObject)->storedPrototype());
		}

	protected:
		static const unsigned StructureFlags = Base::StructureFlags;
	}; //AJNamespaceCorePrototype


	///-------------------------------------------------------------------------------------------------------------------
	NamespaceCore* toNamespaceCore(AJ::AJValue value);
	AJ::AJValue toAJ(AJ::ExecState* exec, AJOAGlobalObject* globalObject, NamespaceCore* impl);

#include "AJNamespaceCore_properties.in.h"
} //namespace Aphid
