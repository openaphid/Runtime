...
#ifndef OpenAphid_AJEvent_h
#define OpenAphid_AJEvent_h
...
namespace Aphid {
	...
	///-------------------------------------------------------------------------------------------------------------------
	class AJEvent : public AJOAObject {
		typedef AJOAObject Base;

	public:
		AJEvent(NonNullPassRefPtr<AJ::Structure> structure, AJOAGlobalObject* globalObject, PassRefPtr<Event> impl);
		virtual ~AJEvent();
	...
	///-------------------------------------------------------------------------------------------------------------------
	class AJEventPrototype : public AJ::AJObject {
		typedef AJ::AJObject Base;

	public:
		AJEventPrototype(NonNullPassRefPtr<AJ::Structure> structure);
		...
		{
			return AJ::asObject(getOAStructure(AJEventBindingType, exec, globalObject)->storedPrototype());
		}
	...
	///-------------------------------------------------------------------------------------------------------------------
	Event* toEvent(AJ::AJValue value);
	AJ::AJValue toAJ(AJ::ExecState* exec, AJOAGlobalObject* globalObject, Event* impl);

#include "AJEvent_properties.in.h"
} //namespace Aphid
