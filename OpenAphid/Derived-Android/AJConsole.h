...
#ifndef OpenAphid_AJConsole_h
#define OpenAphid_AJConsole_h
...
namespace Aphid {
	...
	///-------------------------------------------------------------------------------------------------------------------
	class AJConsole : public AJOAObject {
		typedef AJOAObject Base;

	public:
		AJConsole(NonNullPassRefPtr<AJ::Structure> structure, AJOAGlobalObject* globalObject, PassRefPtr<Console> impl);
		virtual ~AJConsole();
	...
	///-------------------------------------------------------------------------------------------------------------------
	class AJConsolePrototype : public AJ::AJObject {
		typedef AJ::AJObject Base;

	public:
		AJConsolePrototype(NonNullPassRefPtr<AJ::Structure> structure);
		...
		{
			return AJ::asObject(getOAStructure(AJConsoleBindingType, exec, globalObject)->storedPrototype());
		}
	...
	///-------------------------------------------------------------------------------------------------------------------
	Console* toConsole(AJ::AJValue value);
	AJ::AJValue toAJ(AJ::ExecState* exec, AJOAGlobalObject* globalObject, Console* impl);

#include "AJConsole_properties.in.h"
} //namespace Aphid
