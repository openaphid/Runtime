...
#ifndef OpenAphid_AJRect_h
#define OpenAphid_AJRect_h
...
namespace Aphid {
	...
	class AJRectConstructor;

	///-------------------------------------------------------------------------------------------------------------------
	class AJRect : public AJOAObject {
		typedef AJOAObject Base;

	public:
		AJRect(NonNullPassRefPtr<AJ::Structure> structure, AJOAGlobalObject* globalObject, Rect impl);
		virtual ~AJRect();
		...
		Rect data() const {return m_impl;}
		void setData(Rect value) {m_impl = value;}
	...
	///-------------------------------------------------------------------------------------------------------------------
	class AJRectPrototype : public AJ::AJObject {
		typedef AJ::AJObject Base;

	public:
		AJRectPrototype(NonNullPassRefPtr<AJ::Structure> structure);
		...
		{
			return AJ::asObject(getOAStructure(AJRectBindingType, exec, globalObject)->storedPrototype());
		}
	...
	///-------------------------------------------------------------------------------------------------------------------
	class AJRectConstructor : public AJOAConstructor {
		typedef AJOAConstructor Base;

	public:
		AJRectConstructor(AJ::ExecState* exec, AJOAGlobalObject* globalObject);
		...
		static AJ::AJObject* constructRect(AJ::ExecState* exec, AJ::AJObject* constructor, const AJ::ArgList& args);
	...
	///-------------------------------------------------------------------------------------------------------------------
	Rect toRect(AJ::AJValue value);
	AJ::AJValue toAJ(AJ::ExecState* exec, AJOAGlobalObject* globalObject, Rect impl);

#include "AJRect_properties.in.h"
} //namespace Aphid
