...
#ifndef OpenAphid_AJTouchList_h
#define OpenAphid_AJTouchList_h
...
namespace Aphid {
	...
	///-------------------------------------------------------------------------------------------------------------------
	class AJTouchList : public AJOAObject {
		typedef AJOAObject Base;

	public:
		AJTouchList(NonNullPassRefPtr<AJ::Structure> structure, AJOAGlobalObject* globalObject, PassRefPtr<TouchList> impl);
		virtual ~AJTouchList();
	...
	///-------------------------------------------------------------------------------------------------------------------
	class AJTouchListPrototype : public AJ::AJObject {
		typedef AJ::AJObject Base;

	public:
		AJTouchListPrototype(NonNullPassRefPtr<AJ::Structure> structure);
		...
		{
			return AJ::asObject(getOAStructure(AJTouchListBindingType, exec, globalObject)->storedPrototype());
		}

	protected:
		static const unsigned StructureFlags = Base::StructureFlags;
	}; //AJTouchListPrototype


	///-------------------------------------------------------------------------------------------------------------------
	TouchList* toTouchList(AJ::AJValue value);
	AJ::AJValue toAJ(AJ::ExecState* exec, AJOAGlobalObject* globalObject, TouchList* impl);

#include "AJTouchList_properties.in.h"
} //namespace Aphid
