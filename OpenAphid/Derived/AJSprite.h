...
#ifndef OpenAphid_AJSprite_h
#define OpenAphid_AJSprite_h
...
namespace Aphid {
	...
	class Sprite;
	class AJSpriteConstructor;

	///-------------------------------------------------------------------------------------------------------------------
	class AJSprite : public AJNode {
		typedef AJNode Base;

	public:
		AJSprite(NonNullPassRefPtr<AJ::Structure> structure, AJOAGlobalObject* globalObject, PassRefPtr<Sprite> impl);
		virtual ~AJSprite();
		...
		Sprite* impl() const
		{
			return oa_cast<Sprite*>(Base::impl());
		}
	...
	///-------------------------------------------------------------------------------------------------------------------
	class AJSpritePrototype : public AJ::AJObject {
		typedef AJ::AJObject Base;

	public:
		AJSpritePrototype(NonNullPassRefPtr<AJ::Structure> structure);
		...
		{
			return AJ::asObject(getOAStructure(AJSpriteBindingType, exec, globalObject)->storedPrototype());
		}
	...
	///-------------------------------------------------------------------------------------------------------------------
	class AJSpriteConstructor : public AJOAConstructor {
		typedef AJOAConstructor Base;

	public:
		AJSpriteConstructor(AJ::ExecState* exec, AJOAGlobalObject* globalObject);
		...
		static AJ::AJObject* constructSprite(AJ::ExecState* exec, AJ::AJObject* constructor, const AJ::ArgList& args);
	...
	///-------------------------------------------------------------------------------------------------------------------
	Sprite* toSprite(AJ::AJValue value);

#include "AJSprite_properties.in.h"
} //namespace Aphid
