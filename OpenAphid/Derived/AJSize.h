...
#ifndef OpenAphid_AJSize_h
#define OpenAphid_AJSize_h
...
namespace Aphid {
	...
	class AJSizeConstructor;

	///-------------------------------------------------------------------------------------------------------------------
	class AJSize : public AJOAObject {
		typedef AJOAObject Base;

	public:
		AJSize(NonNullPassRefPtr<AJ::Structure> structure, AJOAGlobalObject* globalObject, Size impl);
		virtual ~AJSize();
		...
		Size data() const {return m_impl;}
		void setData(Size value) {m_impl = value;}
	...
	///-------------------------------------------------------------------------------------------------------------------
	class AJSizePrototype : public AJ::AJObject {
		typedef AJ::AJObject Base;

	public:
		AJSizePrototype(NonNullPassRefPtr<AJ::Structure> structure);
		...
		{
			return AJ::asObject(getOAStructure(AJSizeBindingType, exec, globalObject)->storedPrototype());
		}
	...
	///-------------------------------------------------------------------------------------------------------------------
	class AJSizeConstructor : public AJOAConstructor {
		typedef AJOAConstructor Base;

	public:
		AJSizeConstructor(AJ::ExecState* exec, AJOAGlobalObject* globalObject);
		...
		static AJ::AJObject* constructSize(AJ::ExecState* exec, AJ::AJObject* constructor, const AJ::ArgList& args);
	...
	///-------------------------------------------------------------------------------------------------------------------
	Size toSize(AJ::AJValue value);
	AJ::AJValue toAJ(AJ::ExecState* exec, AJOAGlobalObject* globalObject, Size impl);

#include "AJSize_properties.in.h"
} //namespace Aphid
