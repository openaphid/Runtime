...
#ifndef OpenAphid_AJNamespaceAphid_h
#define OpenAphid_AJNamespaceAphid_h
...
namespace Aphid {
	...
	class NamespaceAphid;

	///-------------------------------------------------------------------------------------------------------------------
	class AJNamespaceAphid : public AJOAObject {
		typedef AJOAObject Base;

	public:
		AJNamespaceAphid(NonNullPassRefPtr<AJ::Structure> structure, AJOAGlobalObject* globalObject, PassRefPtr<NamespaceAphid> impl);
		virtual ~AJNamespaceAphid();
		...
		NamespaceAphid* impl() const {return m_impl.get();}
	...
	private:
		RefPtr<NamespaceAphid> m_impl;

	protected:
    static const unsigned StructureFlags = AJ::OverridesGetOwnPropertySlot | Base::StructureFlags;
	}; //class AJNamespaceAphid

	///-------------------------------------------------------------------------------------------------------------------
	class AJNamespaceAphidPrototype : public AJ::AJObject {
		typedef AJ::AJObject Base;

	public:
		AJNamespaceAphidPrototype(NonNullPassRefPtr<AJ::Structure> structure);
		...
		{
			return AJ::asObject(getOAStructure(AJNamespaceAphidBindingType, exec, globalObject)->storedPrototype());
		}

	protected:
		static const unsigned StructureFlags = Base::StructureFlags;
	}; //AJNamespaceAphidPrototype


	///-------------------------------------------------------------------------------------------------------------------
	NamespaceAphid* toNamespaceAphid(AJ::AJValue value);
	AJ::AJValue toAJ(AJ::ExecState* exec, AJOAGlobalObject* globalObject, NamespaceAphid* impl);

#include "AJNamespaceAphid_properties.in.h"
} //namespace Aphid
