...
#ifndef OpenAphid_AJNode_h
#define OpenAphid_AJNode_h
...
namespace Aphid {
	...
	class Node;
	class AJNodeConstructor;

	///-------------------------------------------------------------------------------------------------------------------
	class AJNode : public AJOAObject {
		typedef AJOAObject Base;

	public:
		AJNode(NonNullPassRefPtr<AJ::Structure> structure, AJOAGlobalObject* globalObject, PassRefPtr<Node> impl);
		virtual ~AJNode();
	...
	///-------------------------------------------------------------------------------------------------------------------
	class AJNodePrototype : public AJ::AJObject {
		typedef AJ::AJObject Base;

	public:
		AJNodePrototype(NonNullPassRefPtr<AJ::Structure> structure);
		...
		{
			return AJ::asObject(getOAStructure(AJNodeBindingType, exec, globalObject)->storedPrototype());
		}
	...
	///-------------------------------------------------------------------------------------------------------------------
	class AJNodeConstructor : public AJOAConstructor {
		typedef AJOAConstructor Base;

	public:
		AJNodeConstructor(AJ::ExecState* exec, AJOAGlobalObject* globalObject);
		...
		static AJ::AJObject* constructNode(AJ::ExecState* exec, AJ::AJObject* constructor, const AJ::ArgList& args);
	...
	///-------------------------------------------------------------------------------------------------------------------
	Node* toNode(AJ::AJValue value);
	AJ::AJValue toAJ(AJ::ExecState* exec, AJOAGlobalObject* globalObject, Node* impl);

#include "AJNode_properties.in.h"
} //namespace Aphid
